...
#BOP_DIR = OUTPUT_DIR / "train_pbr" / "000015"
...
N = 2000 #number of images per 00000x
M = 200 #number of backround crops
...
for d in [RGB_DIR, DEPTH_DIR, MASK_DIR, MASK_VISIB_DIR]:
